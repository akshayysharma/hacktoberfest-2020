class Solution(object):
    def findMedianSortedArrays(self, nums1, nums2):
        ...
        while t != 0:
            ...
            leftShortArray, rightShortArray, leftLongArray, rightLongArray = getIndices(
                m, shortArray, longArray)

            t = getDirection(leftShortArray, rightShortArray,
                             leftLongArray, rightLongArray, shortArray, longArray)
            if t < 0:
                r = m - 1
            elif t > 0:
                l = m + 1
